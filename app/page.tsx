...
import { amlAPI, useAsync, AlertResponse } from "../AML_frontend/services/api";
...
export default function Dashboard() {
	...
	const heatmap = useAsync(() => amlAPI.getHeatmapData());
	const trend = useAsync(() => amlAPI.getTrendData("24h"));
	const lifecycle = useAsync(() => amlAPI.getAlertLifecycle());
	const institutionRisk = useAsync(() => amlAPI.getInstitutionRisk());
					...
					<div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
						...
						<div style={{ gridColumn: "1 / span 2", minHeight: 120, background: "#071025", borderRadius: 6, padding: 8 }}>
							...
							<div style={{ display: "flex", gap: 8 }}>
								{lifecycle.data ? (
									Object.entries(lifecycle.data).map(([k, v]) => (
